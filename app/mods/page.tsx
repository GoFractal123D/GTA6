...
export default function ModsPage() {
  ...
  // Effet pour initialiser les données du cache après le montage
  useEffect(() => {
    if (!isMounted) return;

    // Initialiser les données du cache après le montage
    if (isCacheValid() && modsCache.data) {
      ...
      setInitialLoadDone(modsCache.hasBeenInitialized);
    }
  }, [isMounted]);
