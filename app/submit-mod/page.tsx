...
import { Upload, X, FileArchive, ImageIcon, FileText } from "lucide-react";
    ...
    <ProtectedRoute>
      ...
      <form className="space-y-8" onSubmit={handleSubmit}>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="installation">Instructions d'installation</Label>
              <Textarea
                id="installation"
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="terms" className="text-sm">
                  J'accepte les conditions d'utilisation et confirme que ce mod
                  ne contient pas de contenu malveillant
                </Label>
              </div>
