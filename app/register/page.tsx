...
export default function RegisterPage() {
  ...
  return (
    <section className="fixed inset-0 w-screen min-h-screen flex items-start sm:items-center justify-center overflow-auto sm:overflow-hidden z-50">
      ...
      <div className="relative z-20 w-full max-w-md mx-auto px-6 py-8 sm:px-8 sm:py-10 md:px-12 md:py-12 rounded-2xl bg-black/70 shadow-2xl border-2 border-pink-500 animate-fade-in flex flex-col items-center mx-4 sm:mx-6 md:mx-8 my-6 sm:my-8 md:my-12 mt-12 sm:mt-6">
        {!showLogin ? (
          <>
