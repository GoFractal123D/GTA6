    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-800 pt-[100px] pb-16">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <Card className="mb-8 bg-gray-900/50 border-gray-800">
          <CardHeader>
            <CardTitle className="text-white flex items-center gap-2">
              ...
              Bienvenue sur VIverse
            </CardTitle>
          </CardHeader>
          <CardContent className="text-gray-300 space-y-4">
            <p>
              En utilisant VIverse, vous acceptez d'être lié par ces conditions
              d'utilisation. Si vous n'acceptez pas ces conditions, veuillez ne
              pas utiliser notre plateforme.
            </p>
            <p>
              <strong>VIverse</strong> est une plateforme communautaire dédiée
              aux fans de jeux vidéo, permettant le partage, la découverte et la
              discussion autour des mods et contenus créatifs.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-8 bg-gray-900/50 border-gray-800">
          ...
          <CardContent className="text-gray-300 space-y-4">
            <p>VIverse a pour mission de :</p>
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                Créer un espace de partage sécurisé pour les créateurs de mods
              </li>
              <li>Faciliter la découverte de contenus créatifs de qualité</li>
              <li>Encourager les échanges constructifs entre membres</li>
              <li>
                Promouvoir la créativité et l'innovation dans la communauté de
                jeux vidéo
              </li>
        ...
        <Card className="mb-8 bg-gray-900/50 border-gray-800">
          ...
          <CardContent className="text-gray-300 space-y-4">
            <p>
              Les comportements suivants sont strictement interdits et peuvent
          ...
          <CardContent className="text-gray-300 space-y-4">
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm">
                  Vous devez être le propriétaire ou avoir l'autorisation
                  d'utiliser tout contenu que vous publiez. Le respect des
                  droits d'auteur est obligatoire.
                </p>
              </div>
              <div>
                <h4 className="font-semibold text-green-400 mb-2">
                ...
                <p className="text-sm">
                  Tout contenu doit respecter les autres utilisateurs. Les
                  critiques constructives sont encouragées, mais les attaques
                  personnelles sont interdites.
                </p>
              </div>
              <div>
                <h4 className="font-semibold text-green-400 mb-2">
                ...
                <p className="text-sm">
                  Les mods et contenus doivent être fonctionnels et respecter
                  les standards de qualité de la communauté.
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="mb-8 bg-gray-900/50 border-gray-800">
          ...
          <CardContent className="text-gray-300 space-y-4">
            <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-4">
              ...
              <p className="text-sm">
                <strong>
                  Le contenu publié reste sous la responsabilité de
                  l'utilisateur.
                </strong>
                Vous êtes entièrement responsable du contenu que vous publiez,
                partagez ou créez sur la plateforme.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <ul className="list-disc list-inside space-y-2 text-sm">
                <li>
                  <strong>Droits d'auteur :</strong> Vous devez posséder les
                  droits ou avoir l'autorisation d'utiliser tout contenu que
                  vous publiez
                </li>
                <li>
                  <strong>Contenu original :</strong> Les mods doivent être vos
                  créations originales ou avoir les autorisations nécessaires
                </li>
                <li>
                  <strong>Respect des marques :</strong> Interdiction d'utiliser
                  des marques déposées sans autorisation
                </li>
                <li>
                  <strong>Contenu illégal :</strong> Aucun contenu illégal,
                  diffamatoire ou nuisible n'est autorisé
                </li>
                <li>
                  <strong>Fair use :</strong> Toute utilisation de contenu
                  protégé doit respecter les principes du fair use
                </li>
              </ul>
            </div>
            ...
            <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
              ...
              <ul className="list-disc list-inside space-y-2 text-sm">
                ...
                <li>
                  Responsabilité légale personnelle pour les dommages causés
                </li>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      <strong>Avertissement :</strong> Premier manquement aux
                      règles
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      <strong>Suspension temporaire :</strong> 1 à 30 jours
                      selon la gravité
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      <strong>Bannissement permanent :</strong> Violations
                      graves ou répétées
                    </span>
                  </div>
                </div>
