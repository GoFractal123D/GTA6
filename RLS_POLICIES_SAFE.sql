-- Script sécurisé pour créer les politiques RLS (vérifie l'existence avant création)
-- ================================================================================
...
BEGIN
    IF NOT EXISTS (
        ...
        AND policyname = 'Community posts are viewable by everyone'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        ...
        AND policyname = 'Post interactions are viewable by everyone'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'post' 
        AND policyname = 'Authenticated users can create interactions'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        ...
        AND policyname = 'Mods are viewable by everyone'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'mods' 
        AND policyname = 'Authenticated users can create mods'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'mods' 
        AND policyname = 'Users can update their own mods'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'mods' 
        AND policyname = 'Users can delete their own mods'
    ) THEN
